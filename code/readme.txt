...
Contributors: sayontan, marcissimus
...
You can install the theme through the WordPress installer under <strong>Themes &rarr; Install themes</strong> by uploading the ZIP file.
...
For the theme in action with the Custom Layout Template see the <a href='https://github.com/sayontan/suffusion/blob/master/code/'>GitHub repository</a>. You can also check out the <a href='https://aquoid.com/showcase/'>showcase</a> for examples of sites using the theme.

1.	The "Scribbles" skin, bundled with the theme, for an informal-looking blog.
2.	The "Photonique" skin in action is set up as a photo blog by using the "Mosaic" layout.
...
Support is available at the <a href='https://github.com/sayontan/suffusion/issues'>theme's GitHub repository</a>.
...
There are some translations distributed <a href='https://github.com/sayontan/suffusion/tree/master/code/translation'>here</a>.
...
Note that the mega-menu width is fixed, and computed based on the number of columns you pick. The width will not auto-adjust based
on the actual number of widgets in the widget area.

== Changelog ==

A detailed change log for the theme is <a href='https://github.com/sayontan/suffusion/blob/master/code/ChangeLog.txt'>published</a> whenever there is a new release.
